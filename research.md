...
- **FlareGS: 4D Flare Removal using Gaussian Splatting for Urban Scenes**  
  *Mayank Chandak, **K. Sai Sri Teja**, Rahul Gopi Raju Matta, Vinayak Gupta, Kaushik Mitra*  
  _ICCV Workshop 2025_  
  Proposed a multi-view flare removal framework using RGB-LiDAR fusion and Gaussian Splatting for robust perception in autonomous driving.  
  [Paper](https://openaccess.thecvf.com/content/ICCV2025W/2COOOL/papers/Chandak_FlareGS_4D_Flare_Removal_using_Gaussian_Splatting_for_Urban_Scenes_ICCVW_2025_paper.pdf) | [Webpage](https://saisriteja.github.io/Flare4DGS/)

- **PhotonSplat: 3D Scene Reconstruction and Colorization from SPAD Sensors**  
  ***K. Sai Sri Teja***, Sreevidya Chintalapati*, Vinayak Gupta*, Mukund Varma T, Haejoon Lee, Aswin Sankaranarayanan, Kaushik Mitra*  
  _ICCP 2025_  
  Presented a novel approach to reconstruct and colorize 3D scenes from noisy SPAD sensor data, along with the PhotonScenes dataset.  
  [Paper](https://arxiv.org/pdf/2506.21680) | [Project Page](https://vinayak-vg.github.io/PhotonSplat/) | [Code](https://github.com/Vinayak-VG/PhotonSplat)

## 2024
- **DIVA: Deep Indic Virtual Apparel Try-On**  
  * **K. Sai Sri Teja**, Hrishith Mitra, Girish Rongali, Kaushik Mitra*  
  _ECCV Workshop 2024_  
  Introduced IndicViton, a diverse high-resolution dataset for Indian clothing and a diffusion-based try-on model tailored for Indic styles.  
  [Paper](https://link.springer.com/chapter/10.1007/978-3-031-91569-7_23) | [Dataset](https://huggingface.co/datasets/saisriteja/DIVA)
...
- **MIPI 2024 Challenge on Nighttime Flare Removal: Methods and Results**  
  *Yuekun Dai, ..., **Kuppa Sai Sri Teja**, Jayakar Reddy A, Girish Rongali, Kaushik Mitra*  
  ...
  [Paper](https://arxiv.org/pdf/2404.19534)
...
- **Imaging Based Cervical Cancer Diagnostics Using Small Object Detection - Generative Adversarial Networks**  
  *Elakkiya R., **K. Sai Sri Teja**, Jegatha Deborah L., Bisogni C., Medaglia C.*  
  ...
  [Paper](https://link.springer.com/article/10.1007/s11042-021-10627-3#:~:text=The%20proposed%20approach%20utilized%20the,learning%20is%20shown%20in%20Fig.)
...
- **3D CNN Based Emotion Recognition Using Facial Gestures**  
  ***K. Sai Sri Teja**, Reddy T.V., Sashank M., Revathi A.*  
  ...
  [Paper](https://link.springer.com/chapter/10.1007/978-981-16-6616-2_30)
