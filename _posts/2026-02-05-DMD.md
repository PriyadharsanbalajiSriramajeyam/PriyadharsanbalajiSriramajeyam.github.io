...
```bibtex
@article{priyadharsan2026dmd,
  title={Distribution Matching Distillation (DMD) for Faster Diffusion Sampling},
  author={Priyadharsan Balaji S and Parth Shinde and Sai Sri Teja Kuppa},
  journal={Priyadharsan's Blog},
  year={2026},
  url={https://PriyadharsanbalajiSriramajeyam.github.io/2026/02/05/DMD.html}
}
```
