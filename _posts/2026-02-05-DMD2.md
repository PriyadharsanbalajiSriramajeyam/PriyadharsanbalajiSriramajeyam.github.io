...
<ul>
  ...
  <li><a href="#citations">5. Citations</a></li>
</ul>
</details>
...
```bibtex
@article{priyadharsan2026dmd2,
  title={Distribution Matching Distillation 2 (DMD2)},
  author={Priyadharsan Balaji S and Parth Shinde and Sai Sri Teja Kuppa},
  journal={Priyadharsan's Blog},
  year={2026},
  url={https://PriyadharsanbalajiSriramajeyam.github.io/2026/02/06/DMD2.html}
}
```
